        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-10 col-12">
                            <div>
                                <img :src="`${$API_URL}/storage/uploads/${getThambImage?.img}`" alt=""
                                    class="w-100 h-auto">
                            </div>
                            <div class="p-3">
                ...
                data?.category?.name }}</RouterLink>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="product-detail">
                            <h2 class="product-title text-capitalize">{{ data?.title }} - {{
                selectVarientProduct.varient?.replace(/\//g, '-').slice(0, -1) }}</h2>
                            <p class="fs-3 text-secondary">by <RouterLink to=""
                                    class="fw-semibold text-dark text-capitalize">{{
                data?.category?.name }}</RouterLink>
                            </p>
                            ...
                            <div class="accordion accordion-flush my-5" id="accordionFlushExample">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingOne">
                                        <button
                                            class="accordion-button collapsed fw-semibold text-dark fs-3 shadow-none"
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingThree">
                                        <button
                                            class="accordion-button collapsed  text-dark fw-semibold fs-3 shadow-none"
                        ...
                        <div class="featured-collection mt-6">
                            ...
                            <div class="my-5 text-center">
                                <RouterLink to="/" class="py-2 px-4 bg-info text-uppercase text-white d-inline-block">
                                    View More
                                </RouterLink>
                            </div>
                        </div>
